"""
Geologic map of California : Ukiah sheet
"""
...
def run():
    process_usgs_source(
        ...
        url="https://www.conservation.ca.gov/cgs/Documents/Publications/Geologic-Atlas-Maps/"
            "GAM_24-Ukiah-1960-GIS.zip",
        extracted_file_path="GAM_24-Ukiah-1960-GIS/GAM_24_Ukiah-open/"
                            "GM_MapUnitPolys.shp",
        srs=NAD83_CA_ALBERS,
        use_unzip=True,
        polygons_join_col="MapUnit",
        mappable_metadata_csv_path="GAM_24-Ukiah-1960-GIS/GAM_24_Ukiah-open/"
