...
# aren't that...
separated_polygons_path = "polygons-separated.shp"
util.call_cmd([
  "ogr2ogr",
    "-overwrite",
    "-where", "POLY_ID != '1'",
    separated_polygons_path, polygons_path
])
...
util.call_cmd([
  "ogr2ogr",
    ...
    final_polygons_path, separated_polygons_path,
    "-overwrite",
    "-dialect", "sqlite",
...
map_unit_data = [
  [
    "Qu",
    "Surficial deposits, undivided (Pleistocene and Holocene)",
    """
      For
  ...
  [
    "Qls",
    "Landslide deposits (Pleistocene and Holocene)",
    """
      Landslides 
  ...
  [
    "Tb",
    "Basaltic intrusive rocks (Pliocene)",
    "Hypabyssal basalt dikes and sills."
  ],
  [
    "Tsv",
    "Silicic intrusive rocks (Miocene)",
    "Rhyolite to andesite porphyry stocks, dikes and sills."
  ],
  [
    "KJf",
    "Franciscan Complex (Jurassic to Upper Cretaceous)",
    """
      Sheared 
  ...
  [
    "fc",
    "Franciscan Complex (Jurassic to Upper Cretaceous) chert",
    ""
  ],
  [
    "fss",
    "Franciscan Complex (Jurassic to Upper Cretaceous) hard graywacke and shale",
    ""
  ],
  [
    "fg",
    "Franciscan Complex (Jurassic to Upper Cretaceous) greenstone",
    ""
  ],
  [
    "fbc",
    "Franciscan Complex (Jurassic to Upper Cretaceous) basalt and chert",
    ""
  ],
  [
    "fm",
    "Franciscan Complex (Jurassic to Upper Cretaceous) melange",
    """
      Melange of metamorphic rocks including 
      glaucophane and other schistose rocks in sheared sandstone 
      and shale matrix
    """
  ],
  [
    "fs",
    "Franciscan Complex (Jurassic to Upper Cretaceous) sandstone (graywacke)",
    ""
  ],
  ...
  [
    "Tgs",
    "Unnamed sandstone and siltstone (Eocene, Oligocene, and Miocene)",
    "Glauconitic sandstone and brown massive siltstone."
  ],
  ["Tsh", "Greenish gray shale (Eocene)", ""],
  [
    "Kph",
    "Pinehurst Shale (Late Cretaceous)",
    """
  ...
  [
    ...
    "Mainly shale with minor sandstone."
  ],
  [
    "Ko",
    "Oakland Conglomerate (Late Cretaceous)",
    """
      Conglomerate 
  ...
  [
    "Jsv",
    "Coast Range Ophiolite (Jurassic) Keratophyre",
    "Altered silicic volcanic rocks including keratophyre and quartz keratophyre."
  ],
  ...
  [
    "Tus",
    "Unnamed sedimentary and volcanic rocks (Miocene and Pliocene)",
    """
      Includes marine and nonmarine conglomerate, 
  ...
  [
    "Tub",
    "basalt (Miocene and Pliocene)",
    ""
  ],
  [
    "Tul",
    "limestone (Miocene and Pliocene)",
    ""
  ],
  [
    "Tpt",
    ...
    """
      ...
      pumice fragments.  Tuff dated by K/Ar about 5.2 Ma (Sarna-Wojcicki, 1976).
    """
  ],
  ...
  [
    "Tc",
    "Cierbo Sandstone (Miocene)",
    """
      Blue, brown, gray, and white 
      marine sandstone, minor conglomerate, tuff, and shale.
    """
  ],
  [
    "Tbr",
    "Briones Formation (Miocene)",
    """
      Sandstone, siltstone, 
  ...
  [
    "Tbg",
    "Briones Formation (Miocene) G member of Wagner (1978)",
    """
      Massive sandstone, 
      pebble conglomerate, and shell breccia.
    """
  ],
  [
    "Tbf",
    "Briones Formation (Miocene) F member of Wagner (1978)",
    """
  ...
  [
    "Tbe",
    "Briones Formation (Miocene) E member of Wagner (1978)",
    """
      Medium-grained   
  ...
  [
    "Tbd",
    "Briones Formation (Miocene) D member of Wagner (1978)",
    "Massive, medium-grained sandstone with local conglomerate layers."
  ],
  ...
  [
    "Tts",
    "Tuffaceous sandstone (Oligocene or Miocene?)",
    """
      Light-gray tuffaceous sandstone, minor conglomerate and siltstone, 
  ...
  [
    "Tcgl",
    "Conglomerate, sandstone, siltstone (Miocene and Pliocene)",
    """ 
  ...
  [
    "Tsr",
    "San Ramon Sandstone (Oligocene and/or Miocene)",
    """
      Bluish-gray to brown, medium-grained sandstone with conglomerate 
      locally present in basal part.
    """
  ],
  [
    "Tes",
    "Escobar Sandstone of Weaver (1953) (Eocene)",
    """
      Massive, medium- to coarse- grained, brown sandstone with shale in 
      basal part.
    """
  ],
  ...
  [
    "Tgvt",
    "Green Valley and Tassajara Formations of Conduit (1938), undivided (Miocene and Pliocene)",
    """
  ...
  [
    "Tgvtt",
    "Green Valley and Tassajara Formations of Conduit (1938), tuff (Miocene and Pliocene)",
    ""
  ],
  ...
  [
    ...
    """
      Poorly consolidated, non-marine, 
  ...
  [
    ...
    """
      Non-marine, pumiceous, andesitic 
  ...
  [
    ...
    "Neroly Sandstone (Miocene)",
    """
      Blue, volcanic- rich, cross-bedded sandstone and conglomerate; mainly nonmarine.  The 
  ...
  [
    "Tks",
    "Kirker Tuff (Oligocene) tuffaceous sandstone, conglomerate and siltstone",
    ""
  ],
  ...
  [
    "Tme",
    "Meganos Formation (Paleocene) Upper member",
    """
      Greenish-gray to light gray, biotite-rich 
  ...
  [
    "Tmd",
    "Meganos Formation (Paleocene) Sandstone member",
    """
      Medium grained, light gray to 
  ...
  [
    "Tmc",
    "Meganos Formation (Paleocene) Shale member",
    """
      Bluish - gray shale with sandstone 
      interbeds.  Division C of Meganos Formation of Clark 
      (1921).
    """
  ],
  ["Tmcss", "Meganos Formation (Paleocene) Sandstone interbeds", ""],
  [
    "Tma",
    "Meganos Formation (Paleocene) Lower member",
    """
  ...
  [
    "Kdv",
    "Deer Valley Sandstone of Colburn (1964) (Late Cretaceous)",
    """
      Fine- to medium-grained, gray, distinctly 
  ...
  [
    "Keu",
    "Great Valley Sequence Unit E - Siltstone and mudstone (Late Cretaceous) Upper member",
    """
      Light gray siltstone, interbedded 
  ...
  [
    "Kel",
    "Great Valley Sequence Unit E - Siltstone and mudstone (Late Cretaceous) Lower member",
    """
  ...
  [
    "Kels",
    "Great Valley Sequence Unit E - Siltstone and mudstone (Late Cretaceous) Sandstone interbeds",
    """
  ...
  [
    "Kd",
    "Great Valley Sequence Unit D - Sandstone (Late Cretaceous)",
    """
      Medium to coarse 
  ...
  [
    "Kds",
    "Great Valley Sequence Unit D - Sandstone (Late Cretaceous) Shale member",
    """
      Brown to gray, micaceous mudstone 
  ...
  [
    "Kcu",
    "Great Valley Sequence Unit C - Sandstone and shale (Late Cretaceous) Upper member",
    "Shale and siltstone."
  ],
  [
    "Kcus",
    "Great Valley Sequence Unit C - Sandstone and shale (Late Cretaceous) Upper member sandstone",
    "Sandstone interbeds."
  ],
  [
    "Kcm",
    "Great Valley Sequence Unit C - Sandstone and shale (Late Cretaceous) Middle member",
    """
      Medium grained, brown to gray, 
  ...
  [
    "Kcl",
    "Great Valley Sequence Unit C - Sandstone and shale (Late Cretaceous) Lower member",
    "Shale and siltstone with minor sandstone."
  ],
  [
    "Kcls",
    "Great Valley Sequence Unit C - Sandstone and shale (Late Cretaceous) Lower member sandstone",
    "Sandstone interbeds."
  ],
  [
    "Kb",
    "Unit B - Sandstone and shale (Early Cretaceous)",
    """
      Base 
  ...
  [
    "Kbsh",
    "Unit B - Sandstone and shale (Early Cretaceous) Shale member",
    """
      Olive-gray mudstone and micaceous 
  ...
  [
    "Kbs",
    "Unit B - Sandstone and shale (Early Cretaceous) Sandstone member",
    """
      Medium grained, olive-brown 
  ...
  [
    "Ka",
    "Unit A - Shale, with minor sandstone (Early Cretaceous)",
    """
      Olive-brown to dark gray siltstone and mudstone.  
      Spherical concretions common.
    """
  ],
  [
    "Kas",
    "Unit A - Shale, with minor sandstone (Early Cretaceous) Sandstone member",
    """
