"""
Geologic map of California : Death Valley sheet
"""
...
def run():
    process_usgs_source(
        ...
        url="https://www.conservation.ca.gov/cgs/Documents/Publications/Geologic-Atlas-Maps/"
            "GAM_04-DeathValley-1974-GIS.zip",
        extracted_file_path="GAM_04-DeathValley-1974-GIS/GAM_04_DeathValley-open/"
                            "GM_MapUnitPolys.shp",
        srs=NAD83_CA_ALBERS,
        use_unzip=True,
        polygons_join_col="MapUnit",
        mappable_metadata_csv_path="GAM_04-DeathValley-1974-GIS/GAM_04_DeathValley-open/"
